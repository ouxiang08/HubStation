...
from hubstation.utils.cache_manager import OpenAISessionCache
    ...
    def get_media_name(self, filename):
        ...
        try:
            _filename_prompt = "I will give you a movie/tvshow file name.You need to return a Json." \
                               ...
                               "\n{\"title\":string,\"version\":string,\"part\":string,\"year\":string," \
                               "\"resolution\":string,\"season\":number|null,\"episode\":number|null} "
