...
from hubstation.downloader.base import BaseDownloader
from hubstation.helper.pan_helper import PanHelper
from hubstation.utils.string_utils import StringUtils


class Pan115(BaseDownloader, ABC):
    schema = "pan115"
    # 下载器ID
    client_id = "pan115"
    ...
    def init_config(self):
        if self._client_config:
            ...
            if self.cookie:
                self._client = PanHelper(cookie=self.cookie)
